$(document).ready(function () {
  ...
  $("#calculate-btn").on("click", function () {
    var calculateAndDisplayScore = function () {
      ...
      if (totalScore > 1606000) {
        $("#score").addClass("red-text");
        $("#msgAlert").addClass("ralr");
       var msg = "Use less vehicals. Instead of using private transport you can use public transport. \n Turn of the Electric equipments whenever you are not using those.";
      } else if (totalScore > 1167927) {
        $("#msgAlert").addClass("yalr");
        $("#score").addClass("yellow-text");
        var msg = " Drive less. Walk, take public transportation, carpool, rideshare or bike to your destination when possible. This not only reduces CO2 emissions, it also lessens traffic congestion and the idling of engines that accompanies it.";
      } else if (totalScore < 438000) {
        $("#score").addClass("green-text");
        $("#msgAlert").addClass("galr");
        var msg = "Great keep it up , You are a Savior! :)";
      } else {
        $("#score").addClass("blue-text");
        $("#msgAlert").addClass("balr");
        var msg = "Good , you can do it better :)";
      }
